...
stargazer(treat_test,treat_test_girl, 
          title = "Effect of treatment on enrollment by gender",
          omit.stat = c("f", "ser", "aic", "ll"),
          intercept.bottom = FALSE,
          header=FALSE,
          summary=FALSE,
          se = list(robust_se.treat_test,robust_se.treat_test_girl))

stargazer(treat_enrollment,treat_enrollment_girl, 
          title = "Effect of treatment on test score by gender",
          omit.stat = c("f", "ser", "aic", "ll"),
          intercept.bottom = FALSE,
          header=FALSE,
          summary=FALSE,
          se = list(robust_se.treat_enrollment,robust_se.treat_enrollment_girl))
```
